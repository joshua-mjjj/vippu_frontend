...
import { clear_messages, 
      clear_errors, download_file, 
      download_file_query_status,
      download_file_query_leave
...
function GenerateExcel(props) {
  ...
  // const [general_disable, setGeneral_D] = React.useState(false);
  // const [report_status_disable, setReport_status_D] = React.useState(false);
  ...
  const handle_Status_Change = (e) => {
   ...
   const handle_submit_data = (e) => {
    const url_status = "export_battalion_two_status"
