...
function Findemploye(props) {
  ...
  return (
    <Paper sx={{ maxWidth: 1336, margin: 'auto', overflow: 'hidden' }}>
      ...
      {
        props.messages.api_message !== null && props.messages.message_type === "battallion_query_fail" ? 
        (<Alert content={props.messages.api_message} control_bool={control_bool_api_message} status="error" />) : null
      }
      {
