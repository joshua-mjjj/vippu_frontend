...
import { pet_preference, pet_preference_del, sendUserData_pref, sendProvider_photo, getProvider_photo } from "../actions/form.js";
import PetGallery from "../components/ProviderGallery"
import Dialog_Gallery from "./Dialog_Gallery.js";
...
function PetPreferencesSection(props) {
  ...
  React.useEffect(() => {
    ...
    React.useEffect(() => {
      if(props.form.fetch_photos === true || props.form.photo_deleted === true){
          console.log("Fetching photos...")
          props.getProvider_photo()
      }
  }, [props.form.fetch_photos, props.form.photo_deleted]);
      ...
      <Container maxWidth="md" className={classes.wizardContainer}>
        <div>
          ...
          <div className={classes.formGroupLabelPetPrefs__}>
           <FormLabel component="label" className={classes.formGroupLabelPetPrefs}>Upload photos of you with pets for pet owners to see.</FormLabel>
          </div>
          {
          ...
          <Dialog_Gallery setting={setting} />
          <FormLabel component="label" className={classes.formGroupLabelPetPrefs}>Photos</FormLabel>
          <div>
          {
            props.form.photos && props.form.fetch_photos === false  ? 
             (
              <div>{
                 props.form.photos.length !== 0 ? (<PetGallery images={props.form.photos} />) : (<FormLabel component="label" className={classes.formGroupLabelPetPrefs}>No photos yet.</FormLabel>)
               }</div>
             ) : 
             (
              <div style={{
