            ...
            <FormGroup className={classes.formGroup}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  <Input onChange={(e) => setDescription(e.target.value)} value={description} autoComplete="new-password" disableUnderline fullWidth placeholder="Write a few words about the service" inputProps={{ 'aria-label': 'description' }} className={classes.inputSmall} multiline rows={3}/>
                </Grid>
              </Grid>
            </FormGroup>
          </div>
