...
import PetViewSection from "./DashboardViewPetSection";
...
function PetAdditionSection(props) {
  ...
  //  React.useEffect(() => {
  //     console.log(props.breeds)
  //     if(props.breeds_types){
  //        console.log(props.breeds_types) 
  //     } 
      ...
      <Container maxWidth="md" className={classes.addPetSection}>
        {results !== null && results !== undefined && results.length !== 0 ? (
            <div className={classes.showPetSection}>
              <Typography className={classes.formGroupLabel}>Pets</Typography>
                    ...
                    <Grid item xs={12} sm={4}>
                     ...
                     <Grid item xs={12} md={4}>
                     {
                      dog ? ( 
                              <FormLabel component="label" className={classes.formLabel}>Select breed{" "}
                                 <Link  style={{ 'textDecoration': 'none', 'color': 'blue'}}>
                                  (<span onClick={breed_not_found}>Didn't find your Dog breed?</span>)
                                </Link>
                              </FormLabel>
                        ) : ("")
                     }
                     {
                       cat ? ( 
                              <FormLabel component="label" className={classes.formLabel}>Select breed {" "}
                                 <Link  style={{ 'textDecoration': 'none', 'color': 'blue'}}>
                                  (<span onClick={breed_not_found}>Didn't find your Cat breed?</span>)
                                </Link>
                              </FormLabel>
                        ) : ("")
                     }
