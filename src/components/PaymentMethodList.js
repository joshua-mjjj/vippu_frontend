...
import { create_payment_method, get_payment_method, create_payment_method_first, clear_state_payment } from "../actions/form";
      ...
      { show_form === true ?  
        ...
        : ((
             <Button
                variant="outlined"
                color="primary"
                style={{maxWidth: '130px', marginLeft: '45px', marginBottom: '15px', maxHeight: '35px', minWidth: '130px', minHeight: '35px' }}
                onClick={set_show_form}
...
export default connect(mapStateToProps, { 
  create_payment_method, get_payment_method, create_payment_method_first, clear_state_payment
 })(PaymentMethods);
