...
// const Google_Map_Key = "AIzaSyATbMLAN6jGPXdmhGQktLH33X80uPBO_xI"
const Google_Map_Key = "AIzaSyDXc_XVMgtWXeaPvhZVBOFvLGMDMrZaDg8"
  ...
  return (
    <Autocomplete
        ...
        if (newValue && newValue.place_id) {
          geocodeByPlaceId(newValue.place_id)
            .then(results => {
             ...
             // props.onChange(newValue.structured_formatting.main_text, newValue.placeDetails.address_components);
             props.onChange(newValue);
            })
            .catch(error => {
             //  alert(language.google_places_error)
      ...
      onInputChange={(event, newInputValue) => {
        ...
        props.get_typed_value(newInputValue)
